...
/* The first header component for the non-logged dashboards */
export function Header(header, login, signup) {
    header.innerHTML += `
...
/* The second header component for the logged dashboards */
